	...
	abstract class Login {
		...
		public static function getLoginForm() {
			...
			$form .= "<form action='" . $_SERVER['REQUEST_URI'] . "' enctype='multipart/formdata' method='post'>";
				$form .= "<input type='text' name='email' value='eriksteens' />";
				$form .= "<input type='password' name='password' value='erik' />";
		...
		public static function checkCredentials() {
			...
			if(isset($_POST['frmLogin'])) {
				//echo "form submitted, credentials checked and they are good!!";
